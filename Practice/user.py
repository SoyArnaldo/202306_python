...
usuario1.hacer_deposito(400_000)
usuario1.hacer_deposito(500_000)
usuario1.hacer_deposito(200_000)
usuario1.transfer_dinero(usuario3, 200_000)
usuario1.mostrar_balance_usuario()
usuario3.mostrar_balance_usuario()
usuario2.hacer_deposito(250_000)
usuario2.hacer_deposito(150_000)
usuario2.transfer_dinero(usuario1, 100_000)
usuario2.transfer_dinero(usuario3, 100_000)
usuario2.mostrar_balance_usuario()
usuario3.hacer_deposito(350_000)
usuario3.transfer_dinero(usuario2, 100_000)
usuario3.transfer_dinero(usuario1, 100_000)
usuario3.transfer_dinero(usuario2, 100_000)
usuario3.mostrar_balance_usuario()
